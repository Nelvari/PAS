...
<body class="w3-black">
    ...
    <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
        ...
        <a href="/request" class="w3-bar-item w3-button w3-padding-large w3-black">
            <p>Request Bahan</p>
        </a>
    </nav>
    ...
    <div class="w3-padding-large" id="main">
        <div class="w3-container">
            <h2>Request Bahan</h2>
            <h3><a href="{{ url("request/tambahrequest") }}">+ Tambah Request</a></h3>
            ...
            <table class="w3-table-all">
                ...
                <tr class="w3-white">
                    ...
                    <td>{{ $row->jumlahRequest }}</td>
                    <td>{{ $row->namaBahan }}</td>
                    <td>{{ $row->kodeBahan }}</td>
                    <td>
                        <a href="{{ url("request/detailrequest/" . $row->id) }}" class="buttondetail">Detail</a>
                        <a href="{{ url("request/hapusrequest/" . $row->id) }}" class="buttonhapus">Hapus</a>
                    </td>
                </tr> @endforeach
            </table>
        </div>
